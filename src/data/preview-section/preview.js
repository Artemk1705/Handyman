...
export const previewServices = {
  ...
  areas: {
    ...
    Browse our service zones to find local handyman and pressure washing solutions near you — always prompt, professional, and tailored to your property’s needs.`,
  },
  "anna-maria": {
    title: "Trusted Handyman & Pressure Washing in Anna Maria",
    text: `Offering detail-focused home maintenance and exterior cleaning throughout Anna Maria. 
    
    Whether it’s a beachside patio wash, window cleaning, or general repairs — Hritsev BrightFix delivers expert service with care and reliability for every job.`,
  },
  bradenton: {
    title: "Expert Handyman & Pressure Washing in Bradenton",
    text: `BrightFix provides reliable home improvement and pressure washing services in Bradenton. 
    
    From driveway and siding cleaning to interior painting and repairs, our team ensures your property stays clean, functional, and looking its best year-round.`,
  },
  clearwater: {
    title: "Trusted Home Maintenance & Exterior Cleaning in Clearwater",
    text: `BrightFix offers professional handyman and pressure washing services throughout Clearwater. 
    
    Whether it’s cleaning patios and roofs or fixing drywall and installing blinds, we help homeowners keep their spaces clean, functional, and stress-free.`,
  },
  "longboat-key": {
    title: "Premium Handyman & Exterior Care Services in Longboat Key",
    text: `From luxury home maintenance to detailed exterior cleaning, BrightFix delivers top-tier pressure washing and handyman solutions across Longboat Key. 
    
    We focus on quality, reliability, and attention to detail for every service we provide.`,
  },
  "north-port": {
    title: "Dependable Handyman & Pressure Washing in North Port",
    text: `BrightFix provides reliable pressure washing, general repairs, and home improvement services in North Port. 
    
    Whether you need a quick fix or a full exterior refresh, our team delivers professional results with care and precision.`,
  },
  "saint-petersburg": {
    title: "Expert Pressure Washing & Handyman Help in Saint Petersburg",
    text: `BrightFix proudly serves Saint Petersburg with top-rated exterior cleaning, home repairs, and improvement solutions. 
    
    From roof washing to drywall patching, our team ensures spotless results and dependable service every time.`,
  },
  sarasota: {
    title: "Trusted Pressure Washing & Handyman Services in Sarasota",
    text: `BrightFix is your go-to team for expert home maintenance in Sarasota. 
    
    From spotless driveway cleaning to detailed handyman repairs, we deliver prompt, professional results that make your home look and feel its best.`,
  },
  tampa: {
    title: "Complete Pressure Washing & Handyman Help in Tampa",
    text: `From home exteriors to interior fixes, BrightFix provides Tampa residents with reliable handyman solutions and powerful pressure washing services. 
    
    Enjoy quick turnarounds, clean results, and honest pricing with every job.`,
  },
  venice: {
    title: "Professional Home Services in Venice",
    text: `BrightFix proudly serves Venice with expert pressure washing and handyman solutions. 
    
    From spotless exteriors to reliable indoor repairs, we help keep your property clean, functional, and beautiful year-round.`,
  },
};
